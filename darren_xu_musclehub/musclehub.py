...
df = sql_query('''
SELECT 
visits.first_name first_name,
visits.last_name last_name,
visits.gender gender,
visits.email email,
visits.visit_date visit_date,
fitness_tests.fitness_test_date fitness_test_date, 
applications.application_date application_date,
...
plt.axis('equal')
plt.legend(['Fitness Test Completed', 'Fitness Test Not Done'])
plt.show()
...
ax1.set_xticklabels(['Fitness Test (Group A)', 'No Fitness Test (Group B)'])
ax1.set_yticks([0, 0.05, 0.10, 0.15])
ax1.set_yticklabels(['0%', '5%', '10%', '15%'])
plt.title("Impact of Fitness Test to Percentage of Application")
plt.show()
plt.savefig("pct_visitor_application.png")
...
plt.title("Percentage of Membership After Application")
plt.show()
plt.savefig("pct_membership_after_application.png")
...
plt.title("Percentage of Membership on Overall Visitors")
plt.show()
plt.savefig("pct_membership.png")
